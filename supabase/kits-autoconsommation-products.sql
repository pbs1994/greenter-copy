...
SELECT
  ...
  'Kit autoconsommation 3 kWc à 2 975 € (au lieu de 3 500 €) : 6 panneaux photovoltaïques DMEGC 500 Wc, 3 micro-onduleurs Hoymiles HMS-1000-2T et fixations ISY-PV pour toiture inclinée. Installation en monophasé ou triphasé selon le choix du client. Consuel et raccordement Enedis facturés séparément (+700 €).',
  '/solaire.jpg',
  true,
  true,
  '[
...
SELECT
  ...
  'Kit autoconsommation 6 kWc à 5 610 € (au lieu de 6 600 €) : 12 panneaux photovoltaïques DMEGC 500 Wc, 6 micro-onduleurs Hoymiles HMS-1000-2T et fixations ISY-PV pour toiture inclinée. Installation en monophasé ou triphasé selon le choix du client. Consuel et raccordement Enedis facturés séparément (+700 €).',
  '/solaire.jpg',
  true,
  true,
  '[
