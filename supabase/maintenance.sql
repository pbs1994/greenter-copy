...
(
    'Chaudière à gaz',
    'chaudiere-a-gaz',
    'Entretien annuel obligatoire de votre chaudière à gaz.',
    1500,
    'Flame',
    '["Vérification complète de l''appareil", "Contrôle des émissions et du rendement", "Nettoyage du brûleur et de l''échangeur", "Test des organes de sécurité", "Attestation d''entretien"]'::jsonb,
    true,
    1
),
(
    'Pompe à chaleur',
    'pompe-a-chaleur',
    'Entretien de votre pompe à chaleur (obligatoire tous les 2 ans pour PAC > 4kW).',
    2500,
    'Wind',
    '["Contrôle étanchéité circuit frigorifique", "Vérification du niveau de fluide", "Nettoyage des filtres et échangeurs", "Mesure des performances (COP)", "Attestation d''entretien"]'::jsonb,
    true,
    2
),
(
    'Photovoltaïque',
    'photovoltaique',
    'Entretien annuel de votre installation photovoltaïque.',
    2000,
    'Sun',
    '["Inspection visuelle des panneaux", "Contrôle de l''onduleur", "Vérification des connexions électriques", "Bilan de production", "Nettoyage si nécessaire"]'::jsonb,
    true,
    3
),
(
    ...
    'ballon-thermodynamique',
    'Entretien annuel de votre ballon thermodynamique.',
    1500,
    'Droplets',
    '["Contrôle du compresseur et évaporateur", "Vérification de l''anode de protection", "Test du groupe de sécurité", "Nettoyage du filtre à air", "Contrôle de l''étanchéité"]'::jsonb,
    true,
    4
),
(
    ...
    'Entretien annuel de votre système solaire combiné.',
    2500,
    'SunMedium',
    '["Inspection des capteurs solaires", "Contrôle du fluide caloporteur", "Vérification de la régulation", "Test du circulateur", "Contrôle du ballon de stockage"]'::jsonb,
    true,
    5
),
(
    'Chauffe-eau solaire',
    'chauffe-eau-solaire',
    'Entretien annuel de votre chauffe-eau solaire.',
    1500,
    'SunDim',
    '["Inspection des capteurs", "Contrôle du fluide et antigel", "Vérification de la pompe", "Test du groupe de sécurité", "Purge du circuit si nécessaire"]'::jsonb,
    true,
    6
)
