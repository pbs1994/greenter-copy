...
export function LoginForm() {
  ...
  function onVerifySubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      // Session cookie now set — middleware will let us through. The role
      // router at /partenaires sends admins to /partenaires/admin and
      // approved agents to /partenaires/dashboard.
