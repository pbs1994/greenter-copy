                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <h2 className="text-xl font-bold text-neutral-900 leading-tight">
                            {step === 1 ? "Obtenez votre devis personnalisé" : "Où vous rappeler ?"}
                          </h2>
                          {step === 1 && (
                            <p className="text-sm text-neutral-500 mt-1.5 leading-snug">
                              2 questions rapides, puis un <strong className="text-neutral-700">technicien RGE vous rappelle sous 2h</strong> pour planifier votre visite gratuite.
                            </p>
                          )}
                        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
              <Image
                ...
                alt="Technicien Greenter certifié RGE installant une pompe à chaleur"
                fill
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="#devis"
                  className="inline-flex items-center justify-center gap-2 bg-green-700 hover:bg-green-600 text-white font-bold px-6 py-3.5 rounded-xl transition-all shadow-lg shadow-green-700/20"
                >
                ...
                <PhoneCallTracker
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-neutral-100 hover:bg-neutral-200 text-neutral-900 font-semibold px-6 py-3.5 rounded-xl transition-all"
                >
                  <Phone className="w-4 h-4" />
                  {LP_PHONE_DISPLAY}
                </PhoneCallTracker>
