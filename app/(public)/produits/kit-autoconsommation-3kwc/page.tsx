...
const PRODUCT: ProductV2Data = {
  ...
  description: `
    ...
    <p>Les installations photovoltaïques résidentielles d'une puissance inférieure ou égale à 9 kWc bénéficient de la <strong>TVA à 0 %</strong> sur la fourniture et la pose depuis la loi de finances 2024 — ce kit de 3 kWc en profite intégralement. Nos techniciens RGE QualiPV vous accompagnent dans les démarches de raccordement Enedis.</p>
