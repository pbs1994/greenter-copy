          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <PhoneCallTracker phoneNumber={COMPANY_PHONES.primary.raw} displayNumber={COMPANY_PHONES.primary.display} className="btn-secondary bg-transparent border-white text-white hover:bg-white hover:text-blue-900 text-base px-8 py-4"><Phone className="w-5 h-5" />07 66 97 50 99</PhoneCallTracker>
              </div>
            </div>
