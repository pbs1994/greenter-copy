...
interface HeroSectionProps {
  initialGoogleData: GoogleReviewsResponse
}

export function HeroSection({ initialGoogleData }: HeroSectionProps) {
  const [googleData, setGoogleData] = useState<GoogleReviewsResponse>(initialGoogleData)
          ...
          <div className="lg:col-span-8">
            <div className="grid grid-cols-2 gap-6 items-start">
              <div className="text-white pt-2">
                ...
                <p className="text-4xl xl:text-5xl font-bold leading-tight mb-4" aria-hidden="true">
                  Isolation des combles
                  <br />à partir de{" "}
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-cyan-300">
                    1€
