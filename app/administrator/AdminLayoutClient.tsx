...
const navItems = [
  ...
  { href: '/administrator/maintenance/subscriptions', label: 'Contrats maintenance', icon: ContractIcon },
  { href: '/administrator/maintenance', label: 'Services maintenance', icon: MaintenanceIcon },
];
