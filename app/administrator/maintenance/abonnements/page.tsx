...
export const metadata = { title: 'Abonnements maintenance' }
...
export default async function MaintenancePage() {
  ...
  return (
    <div>
      <Link href="/administrator/maintenance" className="inline-flex items-center gap-1 text-sm text-neutral-500 hover:text-neutral-900 mb-2">
        <ChevronLeft className="w-3.5 h-3.5" />
        Maintenance
      </Link>
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-neutral-900">Abonnements clients</h1>
