...
export default async function NewMaintenanceServicePage() {
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-heading font-bold text-neutral-900">
          Nouveau service de maintenance
        </h1>
        <p className="text-neutral-500 mt-1">
          Créez un nouveau service de maintenance avec ses détails et tarifs
        </p>
      </div>
