        ...
        <div className="mt-3 space-y-1">
          ...
          {batteryCount > 1 && (
            <p className="text-xs text-neutral-500">
              Batteries suppl�mentaires � prix r�duit ({formatPrice(prices.extraBattery)} � au lieu de {formatPrice(prices.battery)} �)
            </p>
          )}
        </div>
      </div>
...
function ComparisonChart() {
  return (
    <div className="p-5 bg-white rounded-xl border border-neutral-100">
      <p className="text-sm font-semibold text-neutral-700 mb-4">Dur�e de vie compar�e</p>
      <div className="space-y-3">
        <div>
      ...
      <p className="text-xs text-neutral-500 mt-3">
        � raison d'un cycle par jour, 10 000 cycles = ~27 ans de dur�e de vie
      </p>
    </div>
  )
}
...
export function BatteryPageV2({ product, prices }: Omit<ProductPageV2Props, 'productType'>) {
  ...
  const faqItems: FAQItem[] = [
    { question: "Cette batterie fonctionne-t-elle seule ?", answer: "Non, la batterie n�cessite un onduleur hybride compatible pour fonctionner. Elle est con�ue pour les onduleurs KSTAR BluE-S mais peut �tre compatible avec d'autres onduleurs 48V." },
    { question: "Quelle est la dur�e de vie de la batterie ?", answer: "Les cellules CATL LiFePO4 sont garanties pour 10 000 cycles � 90% de profondeur de d�charge. � raison d'un cycle par jour, cela repr�sente environ 27 ans." },
    { question: "Puis-je ajouter des batteries plus tard ?", answer: "Oui ! Le syst�me est extensible. Vous pouvez commencer avec 1 module (5.12 kWh) et en ajouter jusqu'� 3 de plus pour atteindre 20.48 kWh." },
    { question: "La batterie peut-elle �tre install�e en ext�rieur ?", answer: "La batterie est certifi�e IP65, mais il est recommand� de l'installer dans un local technique car elle ne doit pas �tre charg�e en dessous de 0�C." },
    { question: "Quelle autonomie avec 5.12 kWh ?", answer: "Avec une consommation moyenne de 400 Wh, vous avez environ 11 heures d'autonomie. Pour une soir�e normale, c'est largement suffisant." },
    { question: "Quelle est la garantie ?", answer: "La batterie b�n�ficie d'une garantie produit de 5 ans et d'une garantie performance de 10 ans par KSTAR." },
  ]

  const specs: ProductSpec[] = [
    { label: "Capacit�", value: "5.12", unit: "kWh" },
    { label: "Technologie", value: "LiFePO4 CATL" },
    { label: "Cycles garantis", value: "10 000" },
    { label: "Tension nominale", value: "51.2", unit: "V" },
    { label: "Profondeur de d�charge", value: "90", unit: "%" },
    { label: "Temp�rature de charge", value: "0� � 50�C" },
  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-gradient-to-b from-green-50/50 via-white to-white">
      <ProductSchema
        name={product.name}
        description="Batterie LiFePO4 CATL 5.12 kWh pour stockage solaire. 10 000 cycles garantis, extensible jusqu'� 20 kWh."
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="flex items-center gap-2 p-3 rounded-xl bg-white border border-green-100">
                ...
                <div>
                  <p className="text-sm font-semibold text-neutral-900">0� � 50�</p>
          ...
          <div className="lg:sticky lg:top-24">
            ...
            <p className="text-neutral-600 text-lg mb-6">
              {product.short_description || "Stockez votre surplus solaire avec les cellules CATL les plus fiables du march�."}
            </p>
            ...
            <div className="p-4 bg-amber-50 rounded-xl border border-amber-200 mb-6 flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-amber-800 text-sm">N�cessite un onduleur hybride</p>
            ...
            <div className="flex flex-wrap gap-4 text-sm text-neutral-600">
              <span className="flex items-center gap-1.5"><Check className="w-4 h-4 text-green-600" /> Paiement s�curis�</span>
        ...
        <div className="mt-16 p-6 bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl border border-green-100">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-neutral-600">Installation par nos techniciens certifi�s RGE incluse dans le prix.</p>
            </div>
          </div>
        </div>
        ...
        {/* FAQ */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-neutral-900 mb-6">Questions fr�quentes</h2>
...
export function InverterPageV2({ product, prices }: Omit<ProductPageV2Props, 'productType'>) {
  ...
  const faqItems: FAQItem[] = [
    ...
    { question: "Combien de panneaux puis-je connecter ?", answer: "L'onduleur accepte jusqu'� 6.5 kW de panneaux solaires avec une tension max de 580V. Avec 2 MPPT ind�pendants, vous pouvez optimiser des orientations diff�rentes." },
    { question: "L'onduleur fonctionne-t-il en cas de coupure ?", answer: "Avec une batterie connect�e, oui. L'onduleur bascule automatiquement sur la batterie en cas de coupure r�seau." },
    { question: "Puis-je l'installer en ext�rieur ?", answer: "Oui, l'onduleur est certifi� IP65. Il peut �tre install� en ext�rieur dans un endroit abrit�." },
  ...
  const specs: ProductSpec[] = [
    ...
    { label: "Tension max entr�e", value: "580", unit: "V" },
  ...
  const features = [
    ...
    { icon: Sun, title: "6.5 kW max", description: "Entr�e panneaux" },
    { icon: Zap, title: "97.6%", description: "Rendement" },
    { icon: Shield, title: "IP65", description: "Usage ext�rieur" },
    { icon: Thermometer, title: "-25� � +60�", description: "Plage fonctionnement" },
  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-gradient-to-b from-blue-50/50 via-white to-white">
      <ProductSchema
        name={product.name}
        description="Onduleur hybride monophas� KSTAR BluE-S 5000D. 5kW de puissance, double MPPT, compatible batteries LiFePO4 48V."
        image={`https://greenter.fr${images[0].url}`}
        price={pricing.total / 100}
        currency="EUR"
        availability="InStock"
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:sticky lg:top-24">
            ...
            <p className="text-neutral-600 text-lg mb-6">
              {product.short_description || "Le cerveau de votre installation solaire. Pr�t pour le stockage."}
            </p>
